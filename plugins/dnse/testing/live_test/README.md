...
| **Live-L3-F05-LongStopLimit** … **F06-ShortStopLimit** | stop-limit fills (#14 evidence) | ❌ **F05 09-07 CRITICAL #82**: placement went out correctly as ONE STOP carrying a limit (#14 evidence ✓) but the ENGINE dispatched the protection as a marketable CLOSE with the entry still resting → naked short while flat; recovered in seconds; F06 not attempted — parked on #82 |
