...
Tài liệu này hướng dẫn cách thiết lập kết nối đến DNSE WebSocket để nhận dữ liệu giao dịch theo thời gian thực.
...
| Kênh dữ liệu (Function)                          | Mô tả (Description)                             | Phân loại (Type) | Tần suất gửi dữ liệu (Frequency)                       | Định dạng Channel                         |
|--------------------------------------------------|-------------------------------------------------|------------------|--------------------------------------------------------|-------------------------------------------|
| [Dữ liệu lệnh thời gian thực](#order-event)      | Dữ liệu lệnh giao dịch theo thời gian thực      | Real-time        | Cập nhật khi lệnh giao dịch trên tài khoản có thay đổi | **order.\{market_type\}.\{encoding\}**    |
| [Dữ liệu vị thế thời gian thực](#position-event) | Dữ liệu vị thế đang nắm giữ theo thời gian thực | Real-time        | Cập nhật khi vị thế trên tài khoản có thay đổi         | **position.\{market_type\}.\{encoding\}** |

---

## Các kênh dữ liệu giao dịch

### Dữ liệu lệnh thời gian thực (Order Event) {#order-event}
...
```json lines
{
  ...
  "priceSecure": 1920.0,            // float    // Giá đảm bảo
  "averagePrice": 1921,             // float    // Giá khớp trung bình
...
### Dữ liệu vị thế thời gian thực (Position Event) {#position-event}
