...
Lấy thông tin sức mua và sức bán của tiểu khoản theo mã chứng khoán và gói vay để kiểm tra khả năng đặt lệnh trước khi giao dịch.
...
|» pp0Buy|integer(int32)|false|none|Giá trị sức mua còn lại|
